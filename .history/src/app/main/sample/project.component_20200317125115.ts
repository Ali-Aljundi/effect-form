...
export class ProjectDashboardComponent implements OnInit, OnDestroy
{
    ...
    SendInfo(event: any): void  {
       ...
       this.fbAccountsInfosService.Post_Effect_Activity(effectActivity).subscribe(data => { this.effectActivityResponse = data;   console.log(this.effectActivityResponse.message); },
       err => console.error(err));
        }
